...
export default function SearchBar() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto z-30 relative">
      ...
      {/* Main Search Box */}
      <div className="bg-white rounded-2xl md:rounded-full p-2 md:p-3 shadow-2xl shadow-black/10 flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-100 relative">
        ...
        <div className="flex-1 px-4 py-3 md:py-1 flex items-center gap-3 hover:bg-gray-50 rounded-xl transition-colors cursor-pointer group">
           ...
           <div className="flex flex-col flex-1">
             ...
             <input 
               ...
               className="w-full outline-none text-gray-900 font-medium placeholder:text-gray-400 bg-transparent"
             />
           </div>
        </div>
        ...
        <div className="relative flex-1">
               ...
               <Wallet className="text-gray-400 group-hover:text-primary transition-colors" size={20} />
                <div className="flex flex-col flex-1">
                 <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Price Range</span>
                  <div className="text-gray-900 font-medium truncate">{getPriceLabel()}</div>
               </div>
            </div>
            ...
            {priceOpen && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="absolute top-full left-0 w-full md:w-64 bg-white rounded-xl shadow-xl border border-gray-100 p-4 mt-2 z-50"
                >
        ...
        <div className="relative flex-1">
             ...
             >
               <BedDouble className="text-gray-400 group-hover:text-primary transition-colors" size={20} />
                <div className="flex flex-col flex-1">
                 <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Beds & Baths</span>
                  <div className="text-gray-900 font-medium truncate">{beds === "Any" ? "Any Beds" : `${beds}+ Beds`}</div>
               </div>
            </div>
        ...
        <div className="p-1">
          ...
          >
             <Search size={22} className="md:mr-2" />
